...
def workplanfour():
    ...
    bt19 = Button(c, text='DELETE', width=40, height=1,font=('Times new roman',15),command=workDelete)
    bt19.place(x=500, y=590)
    bt20 = Button(c, text='FIND', width=40, height=1, font=('Times new roman',15), command = finddata)
